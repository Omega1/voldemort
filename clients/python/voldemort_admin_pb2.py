...
_ADMINREQUESTTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='ALL_KEYS', index=12, number=12,
      options=None,
      type=None),
  ],
  options=None,
...
_ALLKEYSREQUEST = descriptor.Descriptor(
  name='AllKeysRequest',
  full_name='voldemort.AllKeysRequest',
  filename='voldemort-admin.proto',
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='store', full_name='voldemort.AllKeysRequest.store', index=0,
      number=1, type=9, cpp_type=9, label=2,
      default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ALLKEYSRESPONSE = descriptor.Descriptor(
  name='AllKeysResponse',
  full_name='voldemort.AllKeysResponse',
  filename='voldemort-admin.proto',
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='error', full_name='voldemort.AllKeysResponse.error', index=0,
      number=1, type=11, cpp_type=10, label=1,
      default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='key', full_name='voldemort.AllKeysResponse.key', index=1,
...
_VOLDEMORTADMINREQUEST = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='all_keys', full_name='voldemort.VoldemortAdminRequest.all_keys', index=13,
...
_ALLKEYSRESPONSE.fields_by_name['error'].message_type = voldemort_client_pb2._ERROR
...
_VOLDEMORTADMINREQUEST.fields_by_name['all_keys'].message_type = _ALLKEYSREQUEST
...
class AllKeysRequest(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ALLKEYSREQUEST

class AllKeysResponse(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ALLKEYSRESPONSE
